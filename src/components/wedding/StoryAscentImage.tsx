...
const variantConfig = {
  ...
  storyCard: {
    ...
    yClamp: [240, 0, 0, 0] as [number, number],
    scrollClamp: [0, 0.48, 0.66, 1] as [number, number],
    scaleClamp: [0.96, 1, 1.08, 1, 1] as [number, number],
    scaleScroll: [0, 0.48, 0.54, 0.66, 1] as [number, number],
    reducedTranslate: "translate-y-0",
    zClass: "z-30",
    scrollInput: [0, 0.66] as [number, number],
    opacityInput: [0, 0.22, 0.48, 0.66, 1] as [number, number],
    opacityOutput: [0.12, 0.42, 1, 1, 1] as [number, number],
